...
//Top Artist Slider
document.addEventListener("DOMContentLoaded", function () {
  const scrollImages = document.querySelector(".top-artist-scroll-images");
  const scrollLength = scrollImages.scrollWidth - scrollImages.clientWidth;
  const leftButton = document.querySelector(".top-artist-left");
  const rightButton = document.querySelector(".top-artist-right");
  const cover = document.querySelector(".top-artist-cover");
